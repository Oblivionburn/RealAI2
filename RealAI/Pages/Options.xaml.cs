...
public partial class Options : ContentPage
{
    ...
    private void Sw_CanThink_Toggled(object sender, ToggledEventArgs e)
    {
        CanThink = sw_CanThink.IsToggled;
        AppUtil.SetConfig("CanThink", CanThink.ToString());
    }

    private void Sw_CanLearnFromThinking_Toggled(object sender, ToggledEventArgs e)
    {
    ...
    private void Sl_ThinkSpeed_ValueChanged(object sender, ValueChangedEventArgs e)
    {
    ...
    private void Sl_AttentionSpan_ValueChanged(object sender, ValueChangedEventArgs e)
    {
    ...
    private void LoadGrid()
	{
        ...
        Grid.SetColumnSpan(lb_canLearn_box, 4);

        grid.Add(lb_CanLearnFromThinking, 0, row);
        Grid.SetColumnSpan(lb_CanLearnFromThinking, 4);

        BoxView sw_canLearn_box = new BoxView();
        sw_canLearn_box.Color = BackgroundColor;
        grid.Add(sw_canLearn_box, 4, row);
        grid.Add(sw_CanLearnFromThinking, 4, row);
        ...
        Grid.SetColumnSpan(lb_initiate_box, 4);

        grid.Add(lb_Initiate, 0, row);
        Grid.SetColumnSpan(lb_Initiate, 4);

        BoxView sw_initiate_box = new BoxView();
        sw_initiate_box.Color = BackgroundColor;
        grid.Add(sw_initiate_box, 4, row);
        grid.Add(sw_Initiate, 4, row);
